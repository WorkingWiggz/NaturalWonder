...
public class CustomMagicAdapter extends ArrayAdapter<Magic> {
    ArrayList<Magic> classList;
    Activity context;

    public CustomMagicAdapter(Activity applicationContext, ArrayList<Magic> classList) {
