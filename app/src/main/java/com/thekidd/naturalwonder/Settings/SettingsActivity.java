...
public class SettingsActivity extends BaseNWActivity {
    ...
    Button MenuButt;
    Button EraseData;
    Button EraseLocalButt;
    Button UpdateLocalButt;
    Button SettingsHelpButt;
    Button DeveloperHelpButt;
    Button CharacterSheetsHelpButt;
    Button SessionNotesHelpButt;
    Button RollingDiceHelpButt;
    Button LookHelpButt;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        SettingsHelpButt = findViewById(R.id.SettingsHelpButt);
        DeveloperHelpButt = findViewById(R.id.DeveloperHelpButt);
        CharacterSheetsHelpButt = findViewById(R.id.CharacterSheetsHelpButt);
        SessionNotesHelpButt = findViewById(R.id.SessionNotesHelpButt);
        RollingDiceHelpButt = findViewById(R.id.RollingDiceHelpButt);
        LookHelpButt = findViewById(R.id.LookHelpButt);
        ...
        EraseLocalButt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder SaveDiagB = new AlertDialog.Builder(v.getContext());
                SaveDiagB.setMessage("Are you sure want to delete the search data cached locally?");
                SaveDiagB.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        EraseLocalData();
        ...
        SettingsHelpButt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(context, SettingsHelp.class);
                startActivity(i);
            }
        });
        DeveloperHelpButt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(context, DeveloperHelp.class);
                startActivity(i);
            }
        });
        CharacterSheetsHelpButt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(context, CharacterSheetsHelp.class);
                startActivity(i);
            }
        });
        SessionNotesHelpButt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(context, SessionNotesHelp.class);
                startActivity(i);
            }
        });
        RollingDiceHelpButt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(context, RollingDiceHelp.class);
                startActivity(i);
            }
        });
        LookHelpButt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(context, LookUpHelp.class);
                startActivity(i);
            }
        });
